...
\begin{abstract}
Twitter is one of the most popular social networks. \researchproblem{Previous research found that users employ Twitter to communicate about software applications via short messages, commonly referred to as \uri{https://orkg.org/resource/R205056}{tweets}, and that these tweets can be useful for
