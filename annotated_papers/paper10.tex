...
\begin{document}
	%
	\title{\metatitle{SciKGTeX - A LATEX Package to Semantically Annotate Contributions in Scientific Publications}}
	...
	\begin{abstract}
		...
		Our user evaluation shows that SciKGTeX is easy to use, with a \result{score of 79 out of 100 on the System Usability Scale, as participants of the study needed only 7 minutes on average to annotate the main contributions} on a sample abstract of a published paper.
